<?php
    ...
    {
        $sql_query = "DELETE FROM employee WHERE eID = ?";
...
<body>
<h1>
    <img src="img/uniqlo.png" width="50" height="50"> UNIQLO 刪除員工  
...
<form method = "POST" action="">
    <table align = "center">
        <tr>
            <td>員工編號 : </td>
            <td><input type = "text" name = "eWorkID" value = "<?php echo $eWorkID ?>"></td>
        </tr>
        <br>
        ...
        <tr>
            <td colspan = "2" style = "text-align: center">
                ...
                <input type = "submit" name = "btnSMT" value = "刪除員工資料">
            </td>
        </tr>
    </table>
</form>
