...
<body>
    <div class="layout">
        ...
        <div class="addBtn">
            <button id="addList" type="button" style="background-color: #2E4053" onclick="javascript:location.href='newList_employee.php'">
                <i class="far fa-clipboard"></i>新增排班
            </button>
            <button id="addList" type="button" style="background-color: #2E4053" onclick="javascript:location.href='employeePassword.html'">
                <i class="far fa-clipboard"></i>修改密碼
            </button>
            ...
            <input id="sreach" type="submit" value="查詢" style="background-color: #2E4053; color: #D4E6F1; height: 30px; width: 50px" />
        </div>
    </div>
